                ...
                <div class="bg-white px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-12 gap-6">
                        <div class="col-span-full sm:col-span-6">
                            <label for="inquiry_id" class="block text-sm font-medium text-gray-700">Anfrage-ID *</label>
                            <select id="inquiry_id" name="inquiry_id" autocomplete="off"
                                class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                <option @if (!Request::has('inquiry_id')) selected @endif disabled>Bitte Anfrage
                                    auswählen
                                </option>
                                @foreach ($inquiries as $inquiry)
                                    <option value="{{ $inquiry->id }}"
                                        @if ($selectedInquiry ? $selectedInquiry->id == $inquiry->id : false) selected @endif>{{ $inquiry->id }} -
                                        {{ $inquiry->location }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-span-full sm:col-start-1 sm:col-span-6">
                            ...
                            <input type="text" name="purpose" id="purpose" autocomplete="off"
                                ...
                                value="{{ $selectedInquiry ? $selectedInquiry->purpose : '' }}"
                        ...
                        <div class="col-span-full sm:col-span-6">
                            ...
                            <input type="text" name="location" id="location" autocomplete="off"
                                ...
                                value="{{ $selectedInquiry ? $selectedInquiry->location : '' }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </div>
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="length" id="length" autocomplete="off" placeholder="10"
                                    value="{{ $selectedInquiry ? $selectedInquiry->length : '' }}"
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="width" id="width" autocomplete="off" placeholder="10"
                                    value="{{ $selectedInquiry ? $selectedInquiry->width : '' }}"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="raster" id="raster" autocomplete="off" placeholder="10"
                                    value="{{ $selectedInquiry ? $selectedInquiry->raster : '' }}"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    aria-describedby="raster-unit">
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="eaves_height" id="eaves_height" autocomplete="off"
                                    placeholder="10"
                                    value="{{ $selectedInquiry ? $selectedInquiry->eaves_height : '' }}"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-1">
                                <textarea id="notes" name="notes" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    placeholder="Notizen oder Kommentare">{{ $selectedInquiry ? $selectedInquiry->notes : '' }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6 flex justify-between gap-4 border-none">
                    <x-button tag="a" href="{{ route('calculations.index') }}" flat>Abbrechen</x-button>
                    <x-button tag="button" type="submit">Kalkulation speichern</x-button>
                </div>
            </div>
        </form>
    </div>
