<x-app-layout>
    <x-slot name="header">
        Anfrage: {{ $calculation->id }} &mdash; Bearbeitungsansicht
    </x-slot>
    ...
    <div class="w-full h-auto py-12">
        ...
        <form action="{{ route('calculations.update', ['id' => $calculation->id]) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="bg-white px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-12 gap-6">
                        <div class="col-span-full sm:col-span-6">
                            <label for="customer_id" class="block text-sm font-medium text-gray-700">Anfrage-ID *</label>
                            <select id="customer_id" name="customer_id" autocomplete="off" disabled
                                class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm disabled:bg-gray-200 disabled:cursor-not-allowed">
                                <option value="{{ $calculation->inquiry->id }}" disabled selected>
                                    {{ $calculation->inquiry->id }}
                                </option>
                                {{-- <option disabled>Bitte Kunde auswählen</option> --}}
                                {{-- @foreach ($inquiries as $inquiry)
                                    <option value="{{ $inquiry->id }}"
                                        @if ($inquiry->id == $calculation->inquiry_id) selected @endif>{{ $inquiry->id }}
                                    </option>
                                @endforeach --}}
                            </select>
                        </div>
                        ...
                        <div class="col-span-full sm:col-start-1 sm:col-span-6">
                            ...
                            <input type="text" name="purpose" id="purpose" autocomplete="off"
                                placeholder="Lagerhalle für Material" value="{{ $calculation->purpose }}"
                        ...
                        <div class="col-span-full sm:col-span-6">
                            ...
                            <input type="text" name="location" id="location" autocomplete="off"
                                placeholder="Musterstraße 1, 12345 Musterstadt" value="{{ $calculation->location }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </div>
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="width" id="width" autocomplete="off" placeholder="10"
                                    ...
                                    aria-describedby="length-unit">
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                                    <span class="text-gray-500 sm:text-sm" id="width-unit">
                                        mm
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="col-span-full sm:col-span-3">
                            <label for="raster" class="block text-sm font-medium text-gray-700">Raster</label>
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="raster" id="raster" autocomplete="off" placeholder="1"
                                    value="{{ $calculation->raster }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    aria-describedby="length-unit">
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                                    <span class="text-gray-500 sm:text-sm" id="raster-unit">
                                        mm
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="eaves_height" id="eaves_height" autocomplete="off"
                                    placeholder="10" value="{{ $calculation->eaves_height }}"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="snowload" id="snowload" autocomplete="off"
                                    placeholder="10" value="{{ $selectedInquiry ? $selectedInquiry->snowload : '' }}"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="col-span-full sm:col-span-3">
                            <label for="craneload"
                                class="block text-sm font-medium text-gray-700">Kranbahnlast</label>
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="craneload" id="eaves_height" autocomplete="off"
                                    placeholder="10"
                                    value="{{ $selectedInquiry ? $selectedInquiry->craneload : '' }}"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="hookheight" id="hookheight" autocomplete="off"
                                    placeholder="10"
                                    value="{{ $selectedInquiry ? $selectedInquiry->hookheight : '' }}"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-1">
                                <textarea id="notes" name="notes" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    placeholder="Notizen oder Kommentare">{{ $calculation->notes }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6 flex justify-between gap-4 border-none">
                    <x-button tag="a" href="{{ route('calculations.show', ['id' => $calculation->id]) }}"
                        flat>
                        Abbrechen</x-button>
