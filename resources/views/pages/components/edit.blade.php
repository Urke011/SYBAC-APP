<x-app-layout>
    <x-slot name="header">
        Bauteil: {{ $data->name }} &mdash; Bearbeitungsansicht
    </x-slot>
    ...
    <div class="w-full h-auto py-12">
        ...
        <form action="{{ route('components.update', ['id' => $data->id]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="overflow-hidden shadow sm:rounded-md divide-y divide-gray-200">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-full sm:col-start-1 sm:col-span-6">
                            ...
                            <input type="text" name="name" id="name" autocomplete="off"
                                placeholder="Lagerhalle für Material" value="{{ $data->name }}"
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-1">
                                <textarea id="description" name="description" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    placeholder="Notizen oder Kommentare">{{ $data->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-span-full sm:col-span-6">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="text" name="color" id="color" autocomplete="off"
                                    placeholder="Weiß" value="{{ $data->color }}"
                        ...
                        <div class="col-span-full sm:col-span-6">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm" x-data="() => toggleInput({{ $data->is_iso }})">
                                <button type="button"
                        ...
                        <div class="col-span-full sm:col-span-4">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="length" id="length" autocomplete="off"
                                    placeholder="10" value="{{ $data->length }}"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="col-span-full sm:col-span-4">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="weight" id="weight" autocomplete="off"
                                    value="{{ number_format((float) $data->weight, 3, '.', '') }}" placeholder="10" step="0.001" min="0"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="col-span-full sm:col-span-4">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="area" id="area" autocomplete="off"
                                    value="{{ $data->area }}" placeholder="10"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="price_mount" id="price_mount" autocomplete="off"
                                    value="{{ number_format((float) $data->price_mount, 2, '.', '') }}"
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                ...
                                <input type="number" name="price_per_unit" id="price_per_unit" autocomplete="off"
                                    value="{{ number_format((float) $data->price_per_unit, 2, '.', '') }}"
                                    placeholder="10.00" step="0.01" min="0"
                                    class="pr-12 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                ...
                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6 flex justify-between gap-4 border-none">
                    <x-button tag="a" href="{{ route('components.show', ['id' => $data->id]) }}" flat>
                        Abbrechen</x-button>
